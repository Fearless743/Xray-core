...
// quicStreamConn adapts *quic.Stream to net.Conn for command framing.
...
func newQuicStreamConn(stream *quic.Stream, lAddr, rAddr net.Addr) *quicStreamConn {
	return &quicStreamConn{Stream: stream, lAddr: lAddr, rAddr: rAddr}
}
