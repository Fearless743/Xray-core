...
type ServerConfig struct {
	...
	TrafficPattern string                 `protobuf:"bytes,3,opt,name=traffic_pattern,json=trafficPattern,proto3" json:"traffic_pattern,omitempty"`
	unknownFields  protoimpl.UnknownFields
	sizeCache      protoimpl.SizeCache
}
...
const file_proxy_mieru_config_proto_rawDesc = "" +
	"\n" +
	"\x18proxy/mieru/config.proto\x12\x10xray.proxy.mieru\x1a\x1acommon/protocol/user.proto\"\x0e\n" +
	"\fClientConfig\"\x87\x01\n" +
	"\fServerConfig\x120\n" +
	"\x05users\x18\x01 \x03(\v2\x1a.xray.common.protocol.UserR\x05users\x12\x1c\n" +
	"\ttransport\x18\x02 \x01(\tR\ttransport\x12'\n" +
	"\x0ftraffic_pattern\x18\x03 \x01(\tR\x0etrafficPatternBR\n" +
