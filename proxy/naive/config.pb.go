...
// 	protoc        v7.35.1
// source: proxy/naive/config.proto
...
const file_proxy_naive_config_proto_rawDesc = "" +
	"\n" +
	"\x18proxy/naive/config.proto\x12\x10xray.proxy.naive\x1a\x1acommon/protocol/user.proto\"@\n" +
	"\fServerConfig\x120\n" +
	"\x05users\x18\x01 \x03(\v2\x1a.xray.common.protocol.UserR\x05users\"\x0e\n" +
	"\fClientConfigBR\n" +
	"\x14com.xray.proxy.naiveP\x01Z%github.com/xtls/xray-core/proxy/naive\xaa\x02\x10Xray.Proxy.Naiveb\x06proto3"
...
var file_proxy_naive_config_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_proxy_naive_config_proto_goTypes = []any{
	(*ServerConfig)(nil),  // 0: xray.proxy.naive.ServerConfig
	(*ClientConfig)(nil),  // 1: xray.proxy.naive.ClientConfig
	(*protocol.User)(nil), // 2: xray.common.protocol.User
}
var file_proxy_naive_config_proto_depIdxs = []int32{
	2, // 0: xray.proxy.naive.ServerConfig.users:type_name -> xray.common.protocol.User
